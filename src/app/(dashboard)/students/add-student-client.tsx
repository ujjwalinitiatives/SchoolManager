  ...
  return (
    <section className="mb-8 rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950 p-6 shadow-sm sm:p-8">
      ...
      <form id="add-student-form" action={handleSubmit} className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <label className="grid gap-1.5 text-sm font-medium text-slate-700 dark:text-slate-300">
          Admission Number *
          <input name="admissionNumber" required placeholder="STU001" className="rounded-lg border border-slate-300 dark:border-slate-700 bg-transparent px-3 py-2.5 text-sm outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all dark:text-white" />
        </label>
